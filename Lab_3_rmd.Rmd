...
City Equilibrium = 21053
Suburbs Equilibrium = 28945
...
#year 2
Psub2 <-  (0.92*28300)+(0.11*21700)

50000- Psub2

#year 3
Psub3 <- (0.92 *28423) + (0.11*21577)
Psub3
...
customers_exceeded_10_percent <- qnorm(prob_10_percent, mean_customers, sd_customers)
